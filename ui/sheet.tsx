  ...
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 dark:bg-neutral-950",
  {
    variants: {
      side: {
        ...
        left: "inset-y-0 left-0 h-full w-3/4 border-r data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left small:max-w-small",
        right:
          "inset-y-0 right-0 h-full w-3/4  border-l data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right small:max-w-small",
      },
    },
    defaultVariants: {
      side: "right",
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 text-center small:text-left",
      className
    )}
    {...props}
  />
