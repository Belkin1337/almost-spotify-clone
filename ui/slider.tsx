...
>(({ className, ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track className="relative h-[4px] group w-full grow overflow-hidden rounded-full bg-neutral-100 dark:bg-neutral-800">
      <SliderPrimitive.Range className="absolute h-full bg-neutral-100 group-hover:dark:bg-jade-500 group-hover:dark:duration-300 transition-colors dark:bg-neutral-50" />
    </SliderPrimitive.Track>
    <SliderPrimitive.Thumb className={`hidden group-hover:block h-[12px] w-[12px] rounded-full 
    ...
    disabled:pointer-events-none disabled:opacity-50 dark:border-neutral-50
      dark:focus-visible:ring-neutral-300 cursor-pointer`} />
  </SliderPrimitive.Root>
))
