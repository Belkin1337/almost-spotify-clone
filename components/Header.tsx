...
const Header: React.FC<HeaderProps> = ({ children, className }) => {
  ...
  return (
    <div className={twMerge(`h-fit bg-gradient-to-b from-[#074f45] to-transparent rounded-sm bg-opacity-30 p-6`, className)}>
        ...
        <div className="flex justify-between items-center gap-x-4">
          {user ? (
            <div className="flex gap-x-4 items-center">
              <Button onClick={handleLogout} className="bg-white px-6 py-2">Выйти</Button>
            ...
            <>
              ...
              <div>
                <Button onClick={authModal.onOpen} className="bg-white px-6 py-2 font-medium">Войти</Button>
              </div>
            </>
          )}
        </div>
